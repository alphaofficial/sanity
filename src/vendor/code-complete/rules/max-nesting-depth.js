...
3. Consider if some conditions can be combined or inverted`
    ...
    create(context) {
         ...
         */
        function enterNestingStructure(node) {
            currentDepth++;
