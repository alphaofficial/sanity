 ...
 */
export function hasAllowedPrefix(name, allowedPrefixes) {
 ...
 */
export function isBooleanParam(param, ignoreDefault = false) {
 ...
 */
export function isArrayIndex(node) {
    return node.parent &&
 ...
 */
export function isDefaultValue(node) {
    return node.parent &&
 ...
 */
export function isAllowedNumber(num, ignore) {
 ...
 */
export function countFunctionParameters(params, options = {}) {
